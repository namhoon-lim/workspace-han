...
const navigationItems = [
  {
    id: "account",
    icon: "https://c.animaapp.com/FyEwllI9/img/element-main-bnb-icon-5.svg",
    label: "계좌관리",
    isActive: false,
  },
  {
    id: "history",
    icon: "https://c.animaapp.com/FyEwllI9/img/element-main-bnb-icon-6.svg",
    label: "내역관리",
    isActive: false,
  },
  {
    id: "transfer",
    icon: "https://c.animaapp.com/FyEwllI9/img/element-main-bnb-icon-7.svg",
    label: "해외송금",
    isActive: true,
  },
  {
        ...
        <div className="flex items-start justify-center w-full">
          {navigationItems.map((item) => (
            <Button
              key={item.id}
              variant="ghost"
              className="flex items-center justify-center flex-1 gap-2.5 h-auto p-0 hover:bg-transparent"
