    ...
    <section className="flex flex-col items-start gap-[22px] px-6 py-0 w-full">
        ...
        <div className="flex flex-col items-start bg-white w-full">
          <div className="flex flex-col items-start gap-2 w-full">
            <div className="flex flex-col items-start gap-2.5 w-full">
              <h2 className="font-title-18-b font-[number:var(--title-18-b-font-weight)] text-[#0b0c0e] text-[length:var(--title-18-b-font-size)] tracking-[var(--title-18-b-letter-spacing)] leading-[var(--title-18-b-line-height)] [font-style:var(--title-18-b-font-style)]">
                친구를 초대하면
                <br />
                받을 수 있는 혜택이에요!
              </h2>
      ...
      <Card className="w-full bg-white rounded-2xl border border-solid border-[#e9e9e9] shadow-card-list-6-20-25">
        <CardContent className="flex flex-col items-center gap-2.5 pt-0 pb-5 px-5">
          <div className="w-[214px] h-[150px] relative">
            <img
          ...
          <div className="flex flex-col items-center w-full">
            <div className="flex flex-col items-start gap-2.5 w-full">
              <div className="flex flex-col items-center gap-2.5 px-[30px] py-[22px] w-full bg-[#f4f7fd] rounded-md border border-solid border-[#4c67f1]">
                <div className="flex flex-col items-center gap-1.5 w-full">
                  ...
                  <p className="font-title-16-b font-[number:var(--title-16-b-font-weight)] text-black text-[length:var(--title-16-b-font-size)] tracking-[var(--title-16-b-letter-spacing)] leading-[var(--title-16-b-line-height)] text-center [font-style:var(--title-16-b-font-style)] w-full">
                    송금 수수료 할인 쿠폰
                  </p>
                </div>

                <div className="inline-flex items-end justify-center gap-0.5">
                  <span className="text-[#0d56e4] text-[length:var(--title-20-b-font-size)] tracking-[var(--title-20-b-letter-spacing)] leading-[var(--title-20-b-line-height)] whitespace-nowrap font-title-20-b font-[number:var(--title-20-b-font-weight)] text-center [font-style:var(--title-20-b-font-style)]">
                    5,000
                  </span>

                  <div className="inline-flex items-center justify-center px-0 py-[2.5px]">
            ...
            <div className="flex flex-col items-center w-full mt-[-9px]">
              <div className="w-7 h-7 z-[1] bg-white rounded-[14px] border border-solid border-[#dfe3ec] relative">
                <img
                  className="absolute left-[calc(50.00%_-_8px)] bottom-1.5 w-4 h-4"
                  alt="Add icon"
                  src="https://c.animaapp.com/pWVLYNoL/img/ico16-add.svg"
                />
              </div>
                ...
                <div className="flex flex-col items-start gap-3.5 pt-[22px] pb-4 px-4 w-full bg-[#f4f7fd] rounded-md">
                  <div className="flex flex-col items-center gap-2.5 w-full">
                    <div className="flex flex-col items-center gap-1.5 w-full">
                      ...
                      <p className="text-[#0b0c0e] text-[length:var(--title-16-b-font-size)] tracking-[var(--title-16-b-letter-spacing)] leading-[var(--title-16-b-line-height)] font-title-16-b font-[number:var(--title-16-b-font-weight)] text-center [font-style:var(--title-16-b-font-style)] w-full">
                        월렛으로 캐시백
                      </p>
                    </div>

                    <p className="[font-family:'Pretendard-Regular',Helvetica] font-normal text-[#0d1458] text-sm tracking-[-0.28px] leading-[18.2px] text-center w-full">
