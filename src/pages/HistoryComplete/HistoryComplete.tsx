...
const progressSteps = [
  {
    ...
    icon: "https://c.animaapp.com/u8GhiXiH/img/element-step-icon-8.svg",
    hasLine: true,
    isActive: true,
  },
  {
                        ...
                        <div className="flex items-start gap-3.5 relative flex-1 grow">
                          ...
                          <div className="flex flex-col items-start gap-3 pt-1.5 pb-3.5 px-0 relative flex-1 grow">
                            <div className="flex flex-col items-start gap-1 relative self-stretch w-full flex-[0_0_auto]">
                              <div
                                className={`relative self-stretch mt-[-1.00px] ${
                                  index === progressSteps.length - 1
                                    ? "font-title-16-b font-[number:var(--title-16-b-font-weight)]"
                                    : "font-title-16-SB font-[number:var(--title-16-SB-font-weight)]"
                                } text-[#0d56e4] text-[length:var(--title-16-SB-font-size)] tracking-[var(--title-16-SB-letter-spacing)] leading-[var(--title-16-SB-line-height)] [font-style:var(--title-16-SB-font-style)]`}
                              >
                                {step.title}
                              </div>
              ...
              <div className="flex flex-col items-start gap-2.5 relative self-stretch w-full flex-[0_0_auto]">
                <div className="flex flex-col items-start gap-1 relative self-stretch w-full flex-[0_0_auto]">
                  <p className="self-stretch font-body-14-r font-[number:var(--body-14-r-font-weight)] text-[#1c253f] text-center tracking-[var(--body-14-r-letter-spacing)] leading-[var(--body-14-r-line-height)] relative mt-[-1.00px] text-[length:var(--body-14-r-font-size)] [font-style:var(--body-14-r-font-style)]">
                    송금이 완료되어 수취가 가능한 상태입니다. (단, 현지 사정에
                    따라 최종 완료 시점이 달라질 수 있습니다.)
                  </p>
                </div>
              </div>
            </div>
