...
const statusSteps = [
  {
    icon: "https://c.animaapp.com/u8GhiXiH/img/element-step-icon-3.svg",
    title: "송금 신청 완료",
    timestamp: "2025.11.03 11:29:35 KST",
    isCompleted: true,
    hasConnector: true,
    titleColor: "text-[#0d56e4]",
    connectorColor: "bg-[#0d56e4]",
  },
  {
    icon: "https://c.animaapp.com/u8GhiXiH/img/element-step-icon-3.svg",
    title: "입금 완료",
  ...
  {
    icon: "https://c.animaapp.com/u8GhiXiH/img/element-step-icon-4.svg",
    title: "환불 예정",
    timestamp: "2025.11.03 11:29:35 KST",
    isCompleted: false,
    hasConnector: false,
  ...
  {
    icon: "https://c.animaapp.com/u8GhiXiH/img/element-step-icon-5.svg",
    title: "환불 처리 완료",
    timestamp: "2025.11.03 11:29:35 KST",
    isCompleted: false,
    hasConnector: false,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1.5 px-6 py-0 relative self-stretch w-full flex-[0_0_auto] bg-white rounded-[30px_30px_0px_0px]">
        ...
        {/* Progress Steps */}
        <div className="flex flex-col items-start gap-4 pt-0 pb-3.5 px-0 relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
                      ...
                      <div className="flex items-start justify-around gap-3 relative flex-1 grow">
                        <div className="flex items-start gap-3.5 relative flex-1 grow">
                          <div className="inline-flex flex-col items-center gap-1.5 relative self-stretch flex-[0_0_auto]">
                            ...
                            {step.hasConnector && (
                              <div
                                className={`relative flex-1 w-0.5 min-h-4 grow ${step.connectorColor} rounded-[41px]`}
                              />
                            )}
                          </div>
                          <div className="flex flex-col items-start gap-3 pt-1.5 pb-3.5 px-0 relative flex-1 grow">
                            <div className="flex flex-col items-start gap-1 relative self-stretch w-full flex-[0_0_auto]">
                              <h2
                                className={`relative self-stretch mt-[-1.00px] font-title-16-SB font-[number:var(--title-16-SB-font-weight)] ${step.titleColor} text-[length:var(--title-16-SB-font-size)] tracking-[var(--title-16-SB-letter-spacing)] leading-[var(--title-16-SB-line-height)] [font-style:var(--title-16-SB-font-style)]`}
                              >
                                {step.title}
                              </h2>
                              <p className="font-caption-title-13-r font-[number:var(--caption-title-13-r-font-weight)] text-[#717682] text-[length:var(--caption-title-13-r-font-size)] tracking-[var(--caption-title-13-r-letter-spacing)] leading-[var(--caption-title-13-r-line-height)] relative self-stretch [font-style:var(--caption-title-13-r-font-style)]">
                                {step.timestamp}
                              </p>
                            </div>
                          </div>
          ...
          {/* Info Box */}
          <Card className="relative self-stretch w-full flex-[0_0_auto] bg-[#f4f7fd] rounded-xl border-0">
            <CardContent className="flex flex-col items-end justify-center gap-2.5 px-5 py-[22px]">
